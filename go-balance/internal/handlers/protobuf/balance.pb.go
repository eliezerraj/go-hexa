...
func (*HealthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{5}
}
...
func (*StressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{6}
}
...
func (*StressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{7}
}
...
func (*ListBalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{8}
}
...
func (*ListBalanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{9}
}
...
func (*GetBalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{10}
}
...
func (*GetBalanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{11}
}
...
func (*AddBalanceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{12}
}
...
func (*AddBalanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee25a00b628521b1, []int{13}
}
...
var fileDescriptor_ee25a00b628521b1 = []byte{
	...
	,
}
